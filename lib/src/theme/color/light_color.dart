...
class LightColor {
  ...
  static const List<Color> itemGameBackground2 = [
    Color(0xFFF2F149),
    Color(0xFF36B66C)
  ];
  static const List<Color> itemGameBackground3 = [
    Color(0xFFFED84F),
    Color(0xFFFF46D8)
  ];
  static const List<Color> itemGameBackground4 = [
    Color(0xFF5884FD),
    Color(0xFFADDBFC)
  ];
  static const List<Color> itemGameBackground5 = [
    Color(0xFFF62B85),
    Color(0xFF8F3DFB)
  ];

  static const List<Color> itemGameBackground6 = [
    Color(0xFFE3B8FF),
    Color(0xFF7FE7EE)
  ];
